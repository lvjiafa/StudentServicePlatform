<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GradeData.aspx.cs" Inherits="App_Views_GradeData" %>
    ...
    <div class="all-center">
        ...
        <br />
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                DeleteCommand="DELETE FROM 选课及成绩 WHERE (学号 = ?) AND (课程代号 = ?)" 
                InsertCommand="INSERT INTO [选课及成绩] ([学号], [课程代号], [成绩], [修课时间], [备注]) VALUES (?, ?, ?, ?, ?)" 
                ProviderName="<%$ ConnectionStrings:ConnectionString.ProviderName %>" 
                SelectCommand="SELECT * FROM [选课及成绩]" 
                
                UpdateCommand="UPDATE [选课及成绩] SET [成绩] = ?, [修课时间] = ?, [备注] = ? WHERE (([学号] = ?) OR ([学号] IS NULL AND ? IS NULL)) AND (([课程代号] = ?) OR ([课程代号] IS NULL AND ? IS NULL))">
                <DeleteParameters>
                ...
                <InsertParameters>
                    ...
                    <asp:Parameter Name="修课时间" Type="String" />
            ...
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                ...
                DataKeyNames="学号,课程代号" DataSourceID="SqlDataSource1" ForeColor="#333333" 
